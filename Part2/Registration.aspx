    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div>
                ...
                <asp:Button ID="btnRegisterforMerchantAccount" runat="server" Text="Register new Merchant" OnClick="btnRegisterforMerchantAccount_Click" />
            </div>
            ...
            <div>
                ...
                <br />
                <asp:DropDownList ID="ddlSecurityQuestion1" runat="server" Width="286px">
                ...
                <br />
                <asp:Label ID="lblSecurityAnswer1" runat="server" Text="Answer"></asp:Label>
                <br />
                <asp:TextBox ID="txtSecurityAnswer1" runat="server" Width="286px"></asp:TextBox>
            </div>
            ...
            <div>
                ...
                <br />
                <asp:DropDownList ID="ddlSecurityQuestion2" runat="server" Width="286px">
                    <asp:ListItem>What is the make of your first car?</asp:ListItem>
                    <asp:ListItem>What was the last name of your third grade teacher</asp:ListItem>
                </asp:DropDownList>
                <br />
                <asp:Label ID="lblSecurityAnswer2" runat="server" Text="Answer"></asp:Label>
                <br />
                <asp:TextBox ID="txtSecurityAnswer2" runat="server" Width="286px"></asp:TextBox>
            </div>
